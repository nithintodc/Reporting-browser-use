...
## Run Analyzed
**Operator:** mcd+tsgmgmtg@theondemandcompany.com
...
### Where to Improve
1. **21% failure rate (22/104 campaigns)** — investigate and fix to get closer to 100% success
2. **7.5 hour runtime** — optimize prompts/steps to reduce the 3,703 steps; could potentially cut to 4–5 hours
3. **Hybrid approach** — have the agent do all 104, then a human spends 15 min retrying only the 22 failures
